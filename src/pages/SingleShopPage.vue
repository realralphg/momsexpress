      ...
      <div class="row">
        ...
        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
              ...
              <div class="shop_img relative-position" >
                <div class="text-primary text-h4 text-bold text-center shop_name bg-white absolute-top">
                    <p class="q-my-auto absolute-center">Lorem Shop</p>
                </div>
              </div>

            <div class="q-py-md  row justify-center q-gutter-md" style=" margin: 0 auto;">


              <q-card class="my-card col-lg-3 col-md-3 col-sm-2 col-xs-12 content-center"
                      v-for="n in 17"
                      :key="n"
                  ...
                  <q-card-section class="card">
                    ...
                    <div class="row no-wrap items-center">
                        <div class="col text-subtitle2 ellipsis-2-lines text-grey-10" style="max-width:80%">
                  ...
                  <q-card-section class="q-pt-none">
                    <div class="row q-my-sm  justify-between">
                      <div class="row">
                        ...
                        <span class="q-my-auto text-subtitle3 text-grey-6 q-mx-sm" style="text-decoration:line-through"> N4000</span>
                      </div>
