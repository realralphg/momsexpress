<template>
  <div class="q-my-lg" style="padding: 0 4%">
     ...
     <div class="main row q-gutter-sm q-col-gutter no-wrap" style="overflow-X: hidden" >

        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
          <div class="row  justify-between q-mx-auto q-my-md q-py-sm q-pl-md " style="border-bottom: 2px solid #003348" >
            <h5 class="text-h5 text-bold q-my-auto text-primary homepage_heading_font">Trending Products</h5>
            <q-btn color="primary" to="/category" class="q-pr-xs" label="View all" icon-right="chevron_right" flat size="0.7rem"/>
          </div>
              <q-carousel
                  v-model="latest_slides"
                  ...
                  >
                    <div class="row fit justify-start items-center q-gutter-xs q-col-gutter no-wrap">
                      <div
                        ...
                        class="col-lg-4 col-md-4 col-sm-4 col-xs-4 cursor-pointer hover_border_grey text-left"
                        v-for="n in 3" :key="n"
                      >
                        <q-img
                          style=""
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          <div class="row  justify-between q-mx-auto q-pl-md  q-my-md q-py-sm" style="border-bottom: 2px solid #003348" >
            <p class="text-h5 text-bold q-my-auto text-primary">Trending Products</p>
            <q-btn color="primary" to="/category" class="q-pr-none" label="View all" icon-right="chevron_right" flat size="0.7rem"/>
          </div>
            <q-carousel
